...
import com.rktech.imagepicker.cropper.CropOverlayView.CropWindowChangeListener
import com.rktech.imagepicker.cropper.utils.getFilePathFromUri
    ...
    init {
        val options =
            (context as? Activity)?.intent?.getBundleExtra(CropImage.CROP_IMAGE_EXTRA_BUNDLE)
                ?.serializable(CropImage.CROP_IMAGE_EXTRA_OPTIONS)
                ?: if (attrs != null) {
