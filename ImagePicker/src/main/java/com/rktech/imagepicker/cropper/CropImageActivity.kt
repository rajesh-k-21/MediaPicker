...
import com.rktech.imagepicker.cropper.CropImageView.*
import com.rktech.imagepicker.cropper.utils.getUriForFile
import com.rktech.imagepicker.databinding.CropImageActivityBinding
import java.io.File
...
open class CropImageActivity : AppCompatActivity(), OnSetImageUriCompleteListener,
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cropImageOptions = bundle?.serializable(CropImage.CROP_IMAGE_EXTRA_OPTIONS) ?: CropImageOptions()
